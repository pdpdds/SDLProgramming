...
SOCKET Socket::CreateSocket2(int af, int type, const std::string& protocol, char *szTemp)
{
...
// 		if (!p)
// 		{
// 			sprintf(szTemp, "%s - %s", "c", protocol.c_str());
