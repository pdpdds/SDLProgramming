...
bool CGameCore::Initialize()
{
	...
	bg = LoadImage("Resource/back1.bmp", SDLSingleton::GetInstance()->GetRenderer());
	background = LoadImage("Resource/bagkground.bmp", SDLSingleton::GetInstance()->GetRenderer());
	box = LoadImage("Resource/box.bmp", SDLSingleton::GetInstance()->GetRenderer());
	hero = LoadImage("Resource/hero.bmp", SDLSingleton::GetInstance()->GetRenderer(), true);
	
	bloc = LoadImage("Resource/block.bmp", SDLSingleton::GetInstance()->GetRenderer());
	loc = LoadImage("Resource/loc.bmp", SDLSingleton::GetInstance()->GetRenderer());
	pBoarder = LoadImage("Resource/rect.bmp", SDLSingleton::GetInstance()->GetRenderer());
...
#ifdef _WIN32		
		sprintf_s(szFileName, "map%d.txt", iStageNum);
#else
