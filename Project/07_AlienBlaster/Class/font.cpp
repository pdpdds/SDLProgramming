...
Font::Font(string fn) {
  ...
  //charset = " ABCDEFGHIJKLMNOPQRSTUVWXYZÜÄ?bcdefghijklmnopqrstuvwxyzüäöß0123456789!\"?%&/()=?*+'#,.-;:_@?\";
	charset = " ABCDEFGHIJKLMNOPQRSTUVWXYZÜÄ?bcdefghijklmnopqrstuvwxyzüäöß0123456789!\"?%&";
  // 94 Zeichen
