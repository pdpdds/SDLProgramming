...
LOCAL_SRC_FILES := $(SDL_PATH)/SDL2/src/main/android/SDL_android_main.c \
                   ../../../Class/main.cpp \
				   ../../../Class/GUIManager.cpp \
				   ../../../Class/WidgetsContainer.cpp \
				   ../../../Class/MidiManager.cpp
...
LOCAL_SHARED_LIBRARIES := SDL2 SDL2_ttf SDL2_image SDL2_mixer SDL2_net GUIChan sockets
