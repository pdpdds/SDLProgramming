...
///////////////////////////////////////////////////////////////////////////////////////////////////
// CME야간선물호가조회(t2802) ( attr,block,headtype=A )
#pragma pack( push, 1 )

#define NAME_t2802     "t2802"

// 기본입력
typedef struct _t2802InBlock
{
    char    shcode              [   8];    char    _shcode              ;    // [string,    8] 단축코드                       StartPos 0, Length 8
} t2802InBlock, *LPt2802InBlock;
#define NAME_t2802InBlock     "t2802InBlock"

// 출력
typedef struct _t2802OutBlock
{
...
} t2802OutBlock, *LPt2802OutBlock;
#define NAME_t2802OutBlock     "t2802OutBlock"
