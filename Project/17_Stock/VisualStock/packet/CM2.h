...
// 입력
typedef struct _CM2_InBlock
{
} CM2_InBlock, *LPCM2_InBlock;
#define NAME_CM2_InBlock     "InBlock"

// 출력
typedef struct _CM2_OutBlock
{
...
} CM2_OutBlock, *LPCM2_OutBlock;
#define NAME_CM2_OutBlock     "OutBlock"
