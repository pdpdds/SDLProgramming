...
///////////////////////////////////////////////////////////////////////////////////////////////////
// KOSDAQ프로그램매매전체집계(KM) ( attr,block )
#pragma pack( push, 1 )

#define NAME_KM_     "KM_"

// 입력
typedef struct _KM__InBlock
{
    char    gubun               [   1];                                      // [string,    1] 구분값                         StartPos 0, Length 1
} KM__InBlock, *LPKM__InBlock;
#define NAME_KM__InBlock     "InBlock"

// 출력
typedef struct _KM__OutBlock
{
    ...
    char    k50jisu             [   6];    char    _k50jisu             ;    // [float ,  6.2] KOSDAQ50 지수                  StartPos 351, Length 6
    char    k50sign             [   1];    char    _k50sign             ;    // [string,    1] KOSDAQ50 전일대비구분          StartPos 358, Length 1
    char    change              [   6];    char    _change              ;    // [float ,  6.2] KOSDAQ50 전일대비              StartPos 360, Length 6
    char    k50basis            [   4];    char    _k50basis            ;    // [float ,  4.2] KOSDAQ50 베이시스              StartPos 367, Length 4
...
} KM__OutBlock, *LPKM__OutBlock;
#define NAME_KM__OutBlock     "OutBlock"
