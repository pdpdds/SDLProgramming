...
#define NAME_t2545     "t2545"

// 기본입력                       
typedef struct _t2545InBlock
{
    ...
    char    nmin                [   2];    char    _nmin                ;    // [string,    2] N분                             StartPos 9, Length 2
    char    cnt                 [   3];    char    _cnt                 ;    // [string,    3] 조회건수                        StartPos 12, Length 3
    char    bgubun              [   1];    char    _bgubun              ;    // [string,    1] 전일분                          StartPos 16, Length 1
} t2545InBlock, *LPt2545InBlock;
#define NAME_t2545InBlock     "t2545InBlock"

// 기본출력                       
typedef struct _t2545OutBlock
{
    char    eitem               [   2];    char    _eitem               ;    // [string,    2] 상품ID                          StartPos 0, Length 2
    char    sgubun              [   1];    char    _sgubun              ;    // [string,    1] 시장구분                        StartPos 3, Length 1
    char    indcode             [   4];    char    _indcode             ;    // [string,    4] 개인투자자코드                  StartPos 5, Length 4
    char    forcode             [   4];    char    _forcode             ;    // [string,    4] 외국인투자자코드                StartPos 10, Length 4
    char    syscode             [   4];    char    _syscode             ;    // [string,    4] 기관계투자자코드                StartPos 15, Length 4
    char    stocode             [   4];    char    _stocode             ;    // [string,    4] 증권투자자코드                  StartPos 20, Length 4
    char    invcode             [   4];    char    _invcode             ;    // [string,    4] 투신투자자코드                  StartPos 25, Length 4
    char    bancode             [   4];    char    _bancode             ;    // [string,    4] 은행투자자코드                  StartPos 30, Length 4
    char    inscode             [   4];    char    _inscode             ;    // [string,    4] 보험투자자코드                  StartPos 35, Length 4
    char    fincode             [   4];    char    _fincode             ;    // [string,    4] 종금투자자코드                  StartPos 40, Length 4
    char    moncode             [   4];    char    _moncode             ;    // [string,    4] 기금투자자코드                  StartPos 45, Length 4
    char    etccode             [   4];    char    _etccode             ;    // [string,    4] 기타투자자코드                  StartPos 50, Length 4
    char    natcode             [   4];    char    _natcode             ;    // [string,    4] 국가투자자코드                  StartPos 55, Length 4
    char    pefcode             [   4];    char    _pefcode             ;    // [string,    4] 사모펀드투자자코드              StartPos 60, Length 4
    char    jisucd              [   8];    char    _jisucd              ;    // [string,    8] 기준지수코드                    StartPos 65, Length 8
    char    jisunm              [  20];    char    _jisunm              ;    // [string,   20] 기준지수명                      StartPos 74, Length 20
} t2545OutBlock, *LPt2545OutBlock;
#define NAME_t2545OutBlock     "t2545OutBlock"

// 출력1                          , occurs
typedef struct _t2545OutBlock1
{
...
} t2545OutBlock1, *LPt2545OutBlock1;
#define NAME_t2545OutBlock1     "t2545OutBlock1"
