...
typedef struct _s3__OutBlock
{
    ...
    char    premium             [   8];    char    _premium             ;    // [float ,  8.2] 프리미엄                       StartPos 216, Length 8
    char    moneyness           [   1];    char    _moneyness           ;    // [string,    1] ATM구분                        StartPos 225, Length 1
    char    shcode              [   6];    char    _shcode              ;    // [string,    6] 단축코드                       StartPos 227, Length 6
    char    lpvolume            [  15];    char    _lpvolume            ;    // [long  ,   15] LP보유수량                     StartPos 234, Length 15
