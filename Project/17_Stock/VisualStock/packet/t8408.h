...
///////////////////////////////////////////////////////////////////////////////////////////////////
// CME야간선물틱분별체결조회(API용)(t8408) ( attr,block,headtype=A )
#pragma pack( push, 1 )

#define NAME_t8408     "t8408"

// 기본입력                       
typedef struct _t8408InBlock
{
...
} t8408InBlock, *LPt8408InBlock;
#define NAME_t8408InBlock     "t8408InBlock"

// 출력1                          , occurs
typedef struct _t8408OutBlock1
{
...
} t8408OutBlock1, *LPt8408OutBlock1;
#define NAME_t8408OutBlock1     "t8408OutBlock1"
