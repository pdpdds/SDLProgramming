...
///////////////////////////////////////////////////////////////////////////////////////////////////
// 업종챠트(N분)(t8418) ( attr,block,headtype=A )
#pragma pack( push, 1 )

#define NAME_t8418     "t8418"

// 기본입력                       
typedef struct _t8418InBlock
{
    char    shcode              [   3];    char    _shcode              ;    // [string,    3] 단축코드                        StartPos 0, Length 3
    char    ncnt                [   4];    char    _ncnt                ;    // [long  ,    4] 단위(n분)                       StartPos 4, Length 4
...
} t8418InBlock, *LPt8418InBlock;
#define NAME_t8418InBlock     "t8418InBlock"

// 출력                           
typedef struct _t8418OutBlock
{
    char    shcode              [   3];    char    _shcode              ;    // [string,    3] 단축코드                        StartPos 0, Length 3
    ...
    char    s_time              [   6];    char    _s_time              ;    // [string,    6] 업종시작시간(HHMMSS)            StartPos 114, Length 6
    char    e_time              [   6];    char    _e_time              ;    // [string,    6] 업종종료시간(HHMMSS)            StartPos 121, Length 6
    char    dshmin              [   2];    char    _dshmin              ;    // [string,    2] 동시호가처리시간(MM:분)         StartPos 128, Length 2
    char    rec_count           [   7];    char    _rec_count           ;    // [long  ,    7] 레코드카운트                    StartPos 131, Length 7
} t8418OutBlock, *LPt8418OutBlock;
#define NAME_t8418OutBlock     "t8418OutBlock"

// 출력1                          , occurs
typedef struct _t8418OutBlock1
{
...
} t8418OutBlock1, *LPt8418OutBlock1;
#define NAME_t8418OutBlock1     "t8418OutBlock1"
