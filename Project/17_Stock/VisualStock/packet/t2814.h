...
///////////////////////////////////////////////////////////////////////////////////////////////////
// CME야간선물기간별투자자매매추이(챠트) ( attr,block,headtype=A )
#pragma pack( push, 1 )
...
{
    char    gubun1              [   1];    char    _gubun1              ;    // [string,    1] 수치구분(1:수치2:누적)          StartPos 0, Length 1
    char    gubun2              [   1];    char    _gubun2              ;    // [string,    1] 단위구분(1:일2:주3:월)          StartPos 2, Length 1
    char    from_date           [   8];    char    _from_date           ;    // [string,    8] 시작날짜                        StartPos 4, Length 8
    char    to_date             [   8];    char    _to_date             ;    // [string,    8] 종료날짜                        StartPos 13, Length 8
