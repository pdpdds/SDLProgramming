...
///////////////////////////////////////////////////////////////////////////////////////////////////
// ELW거래대금상위(t1966) ( attr,block,headtype=A )
#pragma pack( push, 1 )
...
typedef struct _t1966OutBlock1
{
    ...
    char    value               [  12];    char    _value               ;    // [double,   12] 누적거래대금                   StartPos 68, Length 12
    char    jnilvalue           [  12];    char    _jnilvalue           ;    // [double,   12] 전일거래대금                   StartPos 81, Length 12
