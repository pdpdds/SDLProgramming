...
typedef struct _t0431OutBlock1
{
    ...
    char    price               [   6];    char    _price               ;    // [float ,  6.2] 현재가                          StartPos 98, Length 6
    char    appamt              [  18];    char    _appamt              ;    // [long  ,   18] 평가금액                        StartPos 105, Length 18
    char    dtsunik1            [  18];    char    _dtsunik1            ;    // [long  ,   18] 평가손익                        StartPos 124, Length 18
    char    sunikrt             [  10];    char    _sunikrt             ;    // [float , 10.2] 수익율                          StartPos 143, Length 10
