...
// 입력                           
typedef struct _EU1_InBlock
{
} EU1_InBlock, *LPEU1_InBlock;
#define NAME_EU1_InBlock     "InBlock"

// 출력                           
typedef struct _EU1_OutBlock
{
    ...
    char    OrderID             [  16];    // [string,   16] 주문자Id                        StartPos 574, Length 16
...
} EU1_OutBlock, *LPEU1_OutBlock;
#define NAME_EU1_OutBlock     "OutBlock"
