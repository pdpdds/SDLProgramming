...
///////////////////////////////////////////////////////////////////////////////////////////////////
// 선물옵션차트(틱/n틱)(t8414) ( attr,block,headtype=A )
#pragma pack( push, 1 )
...
typedef struct _t8414InBlock
{
    ...
    char    ncnt                [   4];    char    _ncnt                ;    // [long  ,    4] 단위(n틱)                       StartPos 9, Length 4
...
typedef struct _t8414OutBlock1
{
    ...
    char    openyak             [  12];    char    _openyak             ;    // [long  ,   12] 미결제약정                      StartPos 61, Length 12
