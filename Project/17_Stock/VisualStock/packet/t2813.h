...
///////////////////////////////////////////////////////////////////////////////////////////////////
// CME야간선물시간대별투자자매매추이(t2813) ( attr,block,headtype=A )
#pragma pack( push, 1 )

#define NAME_t2813     "t2813"

// 기본입력                       
typedef struct _t2813InBlock
{
    char    gubun1              [   1];    char    _gubun1              ;    // [string,    1] 수량구분                        StartPos 0, Length 1
    char    gubun2              [   1];    char    _gubun2              ;    // [string,    1] 전일분구분                      StartPos 2, Length 1
    char    cts_time            [   8];    char    _cts_time            ;    // [string,    8] CTSTIME                         StartPos 4, Length 8
    char    cts_idx             [   4];    char    _cts_idx             ;    // [long  ,    4] CTSIDX                          StartPos 13, Length 4
    char    cnt                 [   4];    char    _cnt                 ;    // [string,    4] 조회건수                        StartPos 18, Length 4
    char    gubun3              [   1];    char    _gubun3              ;    // [string,    1] 직전대비구분(C:직전대비)        StartPos 23, Length 1
} t2813InBlock, *LPt2813InBlock;
#define NAME_t2813InBlock     "t2813InBlock"

// 기본출력                       
typedef struct _t2813OutBlock
{
...
} t2813OutBlock, *LPt2813OutBlock;
#define NAME_t2813OutBlock     "t2813OutBlock"

// 출력1                          , occurs
typedef struct _t2813OutBlock1
{
...
} t2813OutBlock1, *LPt2813OutBlock1;
#define NAME_t2813OutBlock1     "t2813OutBlock1"
